...
Service Cloud: Cases for service requests</br>
Work Orders: Service job management</br>
Custom Objects: Vehicle__c, Service_History__c, Parts_Inventory__c</br>
Mobile App: Salesforce Mobile for technicians</br>
Process Builder: Service completion notifications to customers</br>
Custom Notifications: Parts low-stock alerts</br>
Reports: Technician productivity, customer satisfaction scores</br>
